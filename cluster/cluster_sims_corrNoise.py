...
def grid_freqNoise_exp(idx):
	...
	def generate_noise(N, beta=0, std=1):
	    """
	    ...
	    Returns:
	    - colored_noise: Generated colored noise sequence of length N.
	    """
	...
	means_emp, variances_emp, all_phis, Is_range = get_distr_empirical(R_m, V_th, eta, tau_m, I_osc, f, M, dt, t, num_trials, range_frac, beta=1)
	...
	filename = 'Data_pink/' + 'experimental_' + '{0:03d}'.format(int(idx/res)) + '_' + '{0:03d}'.format(int(idx%res)) + ".pickle"
